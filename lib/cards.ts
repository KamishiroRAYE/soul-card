...
export const CARDS: GameCard[] = [
  ...
  vanilla("y-omukade", "大百足", 5, "Earth", 6500, 5500, "Beast"),
  ...
  unit("y-jorogumo", "女郎蜘蛛", 4, "Dark", 3000, 3000, ["Beast"], {
    effects: [
      {
        label: "【起動】",
  ...
  unit("y-kudan", "件", 3, "Earth", 1000, 0, ["Beast"], {
    effects: [
      { label: "【召喚時】", text: "このユニットを破壊することで、自分は2枚ドローできる。" },
    ],
  }),
  unit("y-umibozu", "海坊主", 6, "Water", 9000, 6000, ["Ocean"], {
    effects: [
      { label: "【召喚時】", text: "相手フィールドの「海洋」の系譜を持たないカード1枚を破壊する。" },
      {
        label: "【永続】",
  ...
  unit("y-nureonna", "濡女", 3, "Water", 2000, 3000, ["Demon"], {
    effects: [
      {
        label: "【起動】",
        text: "1ターンに1度発動できる。相手は1枚ドローし、そのカードのコスト+1。その後、このカードをリリースし、手札から「牛鬼」1体をコストを支払わずに召喚できる。",
      },
    ],
  }),
  unit("y-mikuzume", "藻女", 1, "Neutral", 1000, 1000, [], {
    effects: [
      {
        label: "【永続】",
        text: "自分のスタートフェイズ開始時、このカードをLv+1し、ATK+1000／HP+1000する。",
      },
      {
        label: "【起動】",
  ...
  unit("n-fenrir", "フェンリル", 9, "Dark", 6000, 12000, ["Beast", "Giant"], {
    effects: [{ label: "【召喚時】", text: "相手フィールドのユニット1体を破壊する。" }],
  }),
  ...
  unit("n-surt", "スルト", 10, "Fire", 10000, 12000, ["Primordial", "GrandEarth", "Giant"], {
    effects: [
      ...
      { label: "【召喚時】", text: "フィールドに存在する他のユニット全てに10000ダメージを与える。" },
    ],
  }),
